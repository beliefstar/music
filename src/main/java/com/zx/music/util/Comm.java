...
//        List<SearchItem> items = search("我的天空", 1);
//        for (SearchItem item : items) {
//            System.out.println(item);
//        }
        String url = "https://www.hifini.com/thread-152.htm";
        HttpRequest request = HttpRequest.get(url)
                .header("Cookie", "bbs_token=GTX1ABMONOcFUu_2B2wFVr15JHc23Caub8VdR3pPjFkMCe_2Bb9HwLmPVB9V99nkczUYCExsAEY9GczcJt2LL195QdUzAFZ1Eq3Z")
                ;
